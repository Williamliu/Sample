    ...
    return {
        ...
        compile: function (el, attrs) {
            return function (sc, el, attrs) {
                $(".lwhWrapBox-Button").live("click.lwhWrapBox", function (ev) {
                    $("#" + $(this).attr("did")).lwhWrapBox();
                    $("#" + $(this).attr("did")).wrapBoxShow();
                });
                ...
                sc.buttonState = function (theNode, btn_name) {
                    ...
                    if (btn_name == "folder" && theNode.nodetable == "pptable" && sc.tree.schema.table.pptable.col == "") btnActive = 0;
                    if (btn_name == "folder" && theNode.nodetable == "pptable" && theNode.nodestate > 0) btnActive = 0;
                ...
                sc.formChange = function (theNode) {
                    if (sc.linkform && ( sc.linkcol || sc.linkselect) ) {
                        if ( (sc.linkform.detail.cols[sc.linkcol]["table"] == theNode.nodetable) || sc.linkselect ) {
                ...
                /************** radiocom  *****************************************/
                            ...
                            '<a class="lwhWrapBox-Button wmliu-common-icon18 wmliu-common-icon18-search" did="lwhWrapBox{{name + \'-\' + theNode.nodetable + \'-\' + theNode.parentid + \'-\' +theNode.nodeid + \'-\' + comcnt }}" title="Please Select"></a> ',
                            ...
                            '</span>',
                            '<div id="lwhWrapBox{{name + \'-\' + theNode.nodetable + \'-\' + theNode.parentid + \'-\' +theNode.nodeid + \'-\' + comcnt }}" ww="400px" hh="30px" class="lwhWrapBox">',

                            '<div class="lwhWrapBox-content {{ theNode.errorMessage[col.col]?\'wmliu-common-input-invalid\':\'\' }}" ',
                                    'style="padding:10px;" ',
									'title="{{ theNode.errorMessage[col.col]?theNode.errorMessage[col.col]:\'\' }}">',
                ...
                //checkbox below
                            '<div class="lwhWrapBox-content {{ theNode.errorMessage[col.col]?\'wmliu-common-input-invalid\':\'\' }}"  ng-init="theNode[col.col]=theNode[col.col]?theNode[col.col]:{};" style="padding:10px;">',
			                    '<span ng-repeat="rdObj in tree.listTables.checklist[col.col]">',
